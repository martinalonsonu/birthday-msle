...
import { VideoWithLoader } from "@/app/components/VideoWithLoader";
  ...
  const screens = [
    {
      ...
      lines: [
        ...
        "Dos personas,",
        "una canción,",
        "y algo que ya venía pasando.",
      ],
      imgSrc: "/18.mp4",
      imgAlt: "video bailando juntos el día del primer beso",
      isVideo: true,
    },
    {
      title: "Tu día",
      lines: [
        "Te vi recibir tu cumpleaños",
        "con esa mezcla tuya",
        "de emoción tranquila",
        "y sonrisa sincera.",
        "",
        "Y pensé:",
      ...
      imgSrc: "/15.jpg",
      imgAlt: "ella recibiendo su cumpleaños",
    },
    {
      title: "Ese momento",
      lines: [
        "Mover todo",
        "por verte feliz.",
        "Pero sobre todo estar.",
        "Compartir el instante.",
        "",
        "Que el reloj marque otro día",
        "y saber con quién lo estás empezando.",
      ],
      imgSrc: "/16.jpg",
      imgAlt: "ambos recibiendo su cumpleaños",
    },
    {
      title: "Tu rastro",
      lines: [
      ...
      imgSrc: "/17.jpg",
      imgAlt: "selfie de ella tomada con mi celular",
    },
  ];
